...
class aidaCountdown {
    constructor(year, month, day, hour, minute, second) {
        ...
        this.timer_countdown.addEventListener('secondsUpdated', function (e) {
        ...
        this.timer_countdown.addEventListener('targetAchieved', function (e) {
    ...
    //TODO: add function to start countdown at startTime or in (startTime - now) seconds
